...
$baseURL = "https://www.hue-design.co.uk/";
//$baseURL = "http://127.0.0.1/projects/HueDesignEditing/";
?>
...
#section1 {
	background: url('<?php echo $baseURL; ?>img/bg-laptop.jpg') no-repeat center 100%;
...
#section3 .banner-left {
    height:50px;
    width: calc(35% + 14px);
    position:absolute;
    top:0;
    left:0;
    background: url('<?php echo $baseURL; ?>img/patterns/darkblue-dot.png');
    z-index: 2;
}

#section3 .banner-left .triangle {
    display: block;
    position: absolute;
    top:0;
    right:-1px;
...
#section3 .banner .banner-center {
    ...
    background: white;
    z-index: 2;
    background: url('<?php echo $baseURL; ?>img/patterns/lightblue-dot.png');
}

#section3 .banner .banner-center .banner-center-border {
    border-top: 3px solid #517fbf;
    position:absolute;
    top:0;
    left:0;
    width: 100% 
...
#section3 .banner-right .triangle {
    display: block;
    position: absolute;
    top:0;
    left:-1px;
