...
//Cache of jquery.superscrollorama.js, TimelineMax.min.js, jquery.fancybox.pack.js, jquery.backgroundSize.js
//skrollr.js, ready.js
...
$( document ).ready(function() {
	...
	//If mobile, resize the body
	
	if ( (/Android|iPhone|iPad|iPod|BlackBerry/i).test(navigator.userAgent || navigator.vendor || window.opera) ) {
		$('body').css("height","9000px");
	}
	...
	$('.portfolio-item img:nth-child(2)').mouseover(function() {
		$(this).parent().find('.portfolio-overlay').fadeTo( "fast", 0, function() {});
	});
	$('.portfolio-item img:nth-child(2)').mouseout(function() {
		$(this).parent().find('.portfolio-overlay').fadeTo( "fast", 1, function() {});
	});
	...
	//Skrollr
	var s = skrollr.init({smoothScrollingDuration: 100});
	...
	$(".fancybox").fancybox({
		afterLoad: function() {
			if (this.element.find('.portfolio-overlay').attr('alt') != "#") {
				this.title = '<a href="http://' + this.element.find('.portfolio-overlay').attr('alt') + '">Visit Website</a> ' + this.title;
			}
		},
		helpers : {
    		title : {
